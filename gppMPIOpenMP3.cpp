...
//Constants that will be used later
    ...
    std::complex<double> achtemp_tot[nend-nstart]; 
...
//Initializing the data structures
   ...
   for(int i=0; i<ncouls; i++)
   {
    ...
    {
        achtemp[iw] = expr0;
	achtemp[iw] = std::complex<double>(0.0, 0.0);
        asxtemp[iw] = expr0;
...
//The main work starts here
    ...
    {
	if(n1 % NTasks != ThisTask) { continue; }
    ...
    MPI_Allreduce(&achtemp, &achtemp_tot, nend-nstart, MPI_DOUBLE_COMPLEX, MPI_SUM, MPI_COMM_WORLD);
